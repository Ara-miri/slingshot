...
// 1. 1501 - 1506 => ApprovalHandler.transferFrom(address,address,address,uint256)
// 2. 1923 - 1930 => Slingshot.rescueTokens(address,address,uint256)
// 3. 1950 - 1959 => Slingshot._transferFromOrWrap(address,address,uint256)
...
// File contracts/ApprovalHandler.sol
...
contract ApprovalHandler is Adminable {
    ...
    // ApprovalHandler.transferFrom(address,address,address,uint256)
    // uses arbitrary from in transferFrom: IERC20(fromToken).safeTransferFrom(sender,to,amount)
...
// File contracts/interface/IWrappedNATIVE.sol
...
// File contracts/interface/SlingshotI.sol
...
// File contracts/lib/ConcatStrings.sol
...
// File contracts/Executioner.sol
...
contract Slingshot is SlingshotI, Adminable, ConcatStrings, ReentrancyGuard {
    ...
    // _transferFromOrWrap(address,address,uint256) 
    // : sends eth to arbitrary user
    // In the line: wrappedNativeToken.deposit{value: amount}()
